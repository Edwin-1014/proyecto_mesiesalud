...
<div class="row">
	...
	<div class="col-6 border border-success p-2 mb-2 border-opacity-25" style="margin: 5px;">
		<div class="row">
			<form action="{{ route('registroMedico.index') }}" class="form form-horizontal" method="get">
				@csrf	
				@if(session('success'))
			...
			<form action="{{ route('registroMedico.store') }}" method="post">
				...
				<div class="col-md-6">
					...
					<input class="form-control" type="date" name="medicoFechaAfiliacion">	     
				</div>
				...
				<div class="col-md-6">
					...
					<input class="form-control" type="date" name="medicoFechaRetiro" value="" placeholder="Selecciona">	
				</div>
				...
				<div class="col-6">
					...
					<div class="form-check">						
						<input class="form-check-input" type="radio" name="medicoEstado" id="flexRadioDefault1" value="Activo">
						<label class="form-check-label" for="flexRadioDefault1">
							Activo
						</label>
					</div>
					<div class="form-check">						
						<input class="form-check-input" type="radio" name="medicoEstado" id="flexRadioDefault2" value="Inactivo">
